...
# 1 "ECU_layer/btn/../../MCAL_layer/GPIO/hal_gpio.h" 1
# 13 "ECU_layer/btn/../../MCAL_layer/GPIO/hal_gpio.h"
...
# 13 "ECU_layer/btn/../../MCAL_layer/GPIO/hal_gpio.h" 2

# 1 "ECU_layer/btn/../../MCAL_layer/GPIO/../mcal_std_types.h" 1
# 13 "ECU_layer/btn/../../MCAL_layer/GPIO/../mcal_std_types.h"
# 1 "ECU_layer/btn/../../MCAL_layer/GPIO/../compilier.h" 1
# 10 "ECU_layer/btn/../../MCAL_layer/GPIO/../compilier.h"
...
# 10 "ECU_layer/btn/../../MCAL_layer/GPIO/../compilier.h" 2
# 13 "ECU_layer/btn/../../MCAL_layer/GPIO/../mcal_std_types.h" 2

# 1 "ECU_layer/btn/../../MCAL_layer/GPIO/../std_libraries.h" 1
# 13 "ECU_layer/btn/../../MCAL_layer/GPIO/../std_libraries.h"
...
# 13 "ECU_layer/btn/../../MCAL_layer/GPIO/../std_libraries.h" 2
...
# 15 "ECU_layer/btn/../../MCAL_layer/GPIO/../std_libraries.h" 2
...
# 16 "ECU_layer/btn/../../MCAL_layer/GPIO/../std_libraries.h" 2
# 14 "ECU_layer/btn/../../MCAL_layer/GPIO/../mcal_std_types.h" 2
# 35 "ECU_layer/btn/../../MCAL_layer/GPIO/../mcal_std_types.h"
...
# 14 "ECU_layer/btn/../../MCAL_layer/GPIO/hal_gpio.h" 2

# 1 "ECU_layer/btn/../../MCAL_layer/GPIO/../device_config.h" 1
# 15 "ECU_layer/btn/../../MCAL_layer/GPIO/hal_gpio.h" 2

# 1 "ECU_layer/btn/../../MCAL_layer/GPIO/hal_gpio_config.h" 1
# 16 "ECU_layer/btn/../../MCAL_layer/GPIO/hal_gpio.h" 2
# 42 "ECU_layer/btn/../../MCAL_layer/GPIO/hal_gpio.h"
typedef enum{
    LOW = 0,
    HIGH
}logic_t;
...
Std_ReturnType ecu_btn_intialize(btn_config *_btn)
{
    ...
    {
       ret = gpio_pin_direction_intialize(&(_btn->_pin));
    }
    return ret;
}
Std_ReturnType ecu_btn_read(btn_config *_btn, btn_status_t* _btn_status_t)
{
    Std_ReturnType ret = (Std_ReturnType)0x1;
    if(_btn == ((void*)0) || _btn_status_t == ((void*)0))
    {
        ret = (Std_ReturnType)0x1;
    }
    else
    {
        ...
        ret = gpio_read_pin(&(_btn->_pin),&pin_logic);
        if(_btn->_active_status == BUTTON_ACTIVE_HIGH)
        {
            if(pin_logic == LOW)
            {
            ...
            else if(pin_logic == HIGH)
            {
                *_btn_status_t = BTN_PRESSURED;
            }
            ret = (Std_ReturnType)0x0;
        }
        else if(_btn->_active_status == BUTTON_ACTIVE_LOW)
        {
            if(pin_logic == HIGH)
            {
                *_btn_status_t = BTN_RELRASED;
