...
# 1 "ECU_layer/Relay/../../MCAL_layer/GPIO/../compilier.h" 1
# 10 "ECU_layer/Relay/../../MCAL_layer/GPIO/../compilier.h"
...
# 10 "ECU_layer/Relay/../../MCAL_layer/GPIO/../compilier.h" 2
...
Std_ReturnType ecu_relay_intialize(relay_config* _relay)
{
    ...
    {
        pin_config relay_pin = { .port_index = _relay->port,
                                 .pin_index = _relay->pin,
...
Std_ReturnType ecu_relay_turn_on (relay_config* _relay)
{
    ...
    else
    {
        ...
        ret = gpio_write_pin(&relay_pin,HIGH);
    }
    return ret;
...
Std_ReturnType ecu_relay_turn_off (relay_config* _relay)
{
    ...
    else
    {
        ...
        ret = gpio_write_pin(&relay_pin,LOW);
    }
    return ret;
