...
# 1 "ECU_layer/LED/../../MCAL_layer/GPIO/../compilier.h" 1
# 10 "ECU_layer/LED/../../MCAL_layer/GPIO/../compilier.h"
...
# 10 "ECU_layer/LED/../../MCAL_layer/GPIO/../compilier.h" 2
...
Std_ReturnType ecu_led_intialize (led_config* led);
Std_ReturnType ecu_led_turn_off (led_config* led);
Std_ReturnType ecu_led_turn_on (led_config* led);
Std_ReturnType ecu_led_toggle (led_config* led);
# 11 "ECU_layer/ecu_intialize.h" 2

# 1 "ECU_layer/btn/ecu_btn.h" 1
# 13 "ECU_layer/btn/ecu_btn.h"
# 1 "ECU_layer/btn/ecu_btn.h" 1
# 13 "ECU_layer/btn/ecu_btn.h" 2
# 23 "ECU_layer/btn/ecu_btn.h"
typedef enum{
    BTN_RELRASED,
    BTN_PRESSURED
}btn_status_t;
...
typedef struct{
    pin_config _pin;
    btn_status_t _btn_status_t;
    active_status _active_status;
}btn_config;



Std_ReturnType ecu_btn_intialize(btn_config *_btn);
Std_ReturnType ecu_btn_read(btn_config *_btn,btn_status_t* _btn_status_t);
# 12 "ECU_layer/ecu_intialize.h" 2
...
Std_ReturnType ecu_relay_intialize(relay_config* _relay);
Std_ReturnType ecu_relay_turn_on (relay_config* _relay);
Std_ReturnType ecu_relay_turn_off (relay_config* _relay);
# 13 "ECU_layer/ecu_intialize.h" 2

# 1 "ECU_layer/DC_MOTOR/ecu_dc_motor.h" 1
# 27 "ECU_layer/DC_MOTOR/ecu_dc_motor.h"
typedef struct{
    pin_config motor_pin[2];
}
dc_motor_config;



Std_ReturnType ecu_dc_motor_intialize (dc_motor_config* _motor);
Std_ReturnType ecu_dc_motor_turn_right (dc_motor_config* _motor);
Std_ReturnType ecu_dc_motor_turn_left (dc_motor_config* _motor);
Std_ReturnType ecu_dc_motor_turn_off (dc_motor_config* _motor);
# 14 "ECU_layer/ecu_intialize.h" 2

# 1 "ECU_layer/7Seg/ecu_7seg.h" 1
# 29 "ECU_layer/7Seg/ecu_7seg.h"
typedef enum{
    COMMAN_ANODE,
    COMMAN_CATHODE
}_7Seg_t;
...
Std_ReturnType ecu_7Seg_intialize(_7Seg_config* _7seg);
Std_ReturnType ecu_7Seg_write(_7Seg_config* _7seg,uint8 num);
# 15 "ECU_layer/ecu_intialize.h" 2

# 1 "ECU_layer/KeyPad/ecu_KeyPad.h" 1
# 27 "ECU_layer/KeyPad/ecu_KeyPad.h"
typedef struct{
    pin_config ROWS_PINS [4];
    pin_config COLUMN_PINS [4];

}keyPad_config;


Std_ReturnType ecu_keyPad_intialize(keyPad_config *keyPad);
Std_ReturnType ecu_keyPad_read_value(keyPad_config *keyPad,uint8 *val);
...
Std_ReturnType ecu_8bit_lcd_initialize(const _8bit_lcd_config * lcd);
Std_ReturnType ecu_8bit_lcd_send_command(const _8bit_lcd_config * lcd ,uint8 command);
Std_ReturnType ecu_8bit_lcd_send_char(const _8bit_lcd_config * lcd ,uint8 ch);
Std_ReturnType ecu_8bit_lcd_send_char_pos(const _8bit_lcd_config * lcd ,
                                          uint8 row, uint8 colum ,uint8 ch);
Std_ReturnType ecu_8bit_lcd_send_string(const _8bit_lcd_config *lcd ,uint8 *str);
Std_ReturnType ecu_8bit_lcd_send_string_pos(const _8bit_lcd_config * lcd ,
                                          uint8 row, uint8 colum ,uint8* str);
Std_ReturnType ecu_8bit_lcd_send_custom_char_pos(const _8bit_lcd_config * lcd ,
                                                 uint8 row, uint8 colum,
                                                 uint8 custom_char[],uint8 mem_pos);
Std_ReturnType ecu_convert_uint16_to_string(uint16 num, uint8 *result);
Std_ReturnType ecu_convert_uint8_to_string(uint8 num, uint8 *result);
# 17 "ECU_layer/ecu_intialize.h" 2
# 7 "ECU_layer/ecu_intialize.c" 2


keyPad_config keypad_1 = {
    .ROWS_PINS[0].direction = OUTPUT_DIRECTION,
    .ROWS_PINS[0].logic = HIGH,
    .ROWS_PINS[0].pin_index = PIN0,
    .ROWS_PINS[0].port_index = PORTC_INDEX,
    .ROWS_PINS[1].direction = OUTPUT_DIRECTION,
    .ROWS_PINS[1].logic = HIGH,
    .ROWS_PINS[1].pin_index = PIN1,
    .ROWS_PINS[1].port_index = PORTC_INDEX,
    .ROWS_PINS[2].direction = OUTPUT_DIRECTION,
    .ROWS_PINS[2].logic = HIGH,
    .ROWS_PINS[2].pin_index = PIN2,
    .ROWS_PINS[2].port_index = PORTC_INDEX,
    .ROWS_PINS[3].direction = OUTPUT_DIRECTION,
    .ROWS_PINS[3].logic = HIGH,
    .ROWS_PINS[3].pin_index = PIN3,
    .ROWS_PINS[3].port_index = PORTC_INDEX,

    .COLUMN_PINS[0].direction = INPUT_DIRECTION,
    .COLUMN_PINS[0].logic = HIGH,
    .COLUMN_PINS[0].pin_index = PIN4,
    .COLUMN_PINS[0].port_index = PORTC_INDEX,
    .COLUMN_PINS[1].direction = INPUT_DIRECTION,
    .COLUMN_PINS[1].logic = HIGH,
    .COLUMN_PINS[1].pin_index = PIN5,
    .COLUMN_PINS[1].port_index = PORTC_INDEX,
    .COLUMN_PINS[2].direction = INPUT_DIRECTION,
    .COLUMN_PINS[2].logic = HIGH,
    .COLUMN_PINS[2].pin_index = PIN6,
    .COLUMN_PINS[2].port_index = PORTC_INDEX,
    .COLUMN_PINS[3].direction = INPUT_DIRECTION,
    .COLUMN_PINS[3].logic = HIGH,
    .COLUMN_PINS[3].pin_index = PIN7,
    .COLUMN_PINS[3].port_index = PORTC_INDEX,
};
_8bit_lcd_config lcd_1 = {
        .EN.direction = OUTPUT_DIRECTION,
        .EN.logic = LOW,
        .EN.port_index = PORTC_INDEX,
        .EN.pin_index = PIN1,
        .RS.direction = OUTPUT_DIRECTION,
        .RS.logic = LOW,
        .RS.port_index = PORTC_INDEX,
        .RS.pin_index = PIN0,
        .DATA[0].direction = OUTPUT_DIRECTION,
        .DATA[0].logic = LOW,
        .DATA[0].port_index = PORTD_INDEX,
        .DATA[0].pin_index = PIN0,
        .DATA[1].direction = OUTPUT_DIRECTION,
        .DATA[1].logic = LOW,
        .DATA[1].port_index = PORTD_INDEX,
        .DATA[1].pin_index = PIN1,
        .DATA[2].direction = OUTPUT_DIRECTION,
        .DATA[2].logic = LOW,
        .DATA[2].port_index = PORTD_INDEX,
        .DATA[2].pin_index = PIN2,
        .DATA[3].direction = OUTPUT_DIRECTION,
        .DATA[3].logic = LOW,
        .DATA[3].port_index = PORTD_INDEX,
        .DATA[3].pin_index = PIN3,
        .DATA[4].direction = OUTPUT_DIRECTION,
        .DATA[4].logic = LOW,
        .DATA[4].port_index = PORTD_INDEX,
        .DATA[4].pin_index = PIN4,
        .DATA[5].direction = OUTPUT_DIRECTION,
        .DATA[5].logic = LOW,
        .DATA[5].port_index = PORTD_INDEX,
        .DATA[5].pin_index = PIN5,
        .DATA[6].direction = OUTPUT_DIRECTION,
        .DATA[6].logic = LOW,
        .DATA[6].port_index = PORTD_INDEX,
        .DATA[6].pin_index = PIN6,
        .DATA[7].direction = OUTPUT_DIRECTION,
        .DATA[7].logic = LOW,
        .DATA[7].port_index = PORTD_INDEX,
        .DATA[7].pin_index = PIN7,

};
btn_config btn_1 = {
    ._active_status = BUTTON_ACTIVE_LOW,
    ._btn_status_t = BTN_RELRASED,
    ._pin.direction = OUTPUT_DIRECTION,
    ._pin.logic = HIGH,
    ._pin.pin_index = PIN2,
    ._pin.port_index = PORTC_INDEX
