...
# 13 "ECU_layer/7Seg/../../MCAL_layer/GPIO/../mcal_std_types.h"
# 1 "ECU_layer/7Seg/../../MCAL_layer/GPIO/../compilier.h" 1
# 10 "ECU_layer/7Seg/../../MCAL_layer/GPIO/../compilier.h"
...
# 13 "ECU_layer/7Seg/../../MCAL_layer/GPIO/../std_libraries.h" 2
...
# 15 "ECU_layer/7Seg/../../MCAL_layer/GPIO/../std_libraries.h" 2
...
# 16 "ECU_layer/7Seg/../../MCAL_layer/GPIO/../std_libraries.h" 2
# 14 "ECU_layer/7Seg/../../MCAL_layer/GPIO/../mcal_std_types.h" 2
# 35 "ECU_layer/7Seg/../../MCAL_layer/GPIO/../mcal_std_types.h"
...
# 15 "ECU_layer/7Seg/../../MCAL_layer/GPIO/hal_gpio.h" 2

# 1 "ECU_layer/7Seg/../../MCAL_layer/GPIO/hal_gpio_config.h" 1
# 16 "ECU_layer/7Seg/../../MCAL_layer/GPIO/hal_gpio.h" 2
# 42 "ECU_layer/7Seg/../../MCAL_layer/GPIO/hal_gpio.h"
typedef enum{
    LOW = 0,
    HIGH
}logic_t;
...
# 13 "ECU_layer/7Seg/ecu_7seg.h" 2
...
Std_ReturnType ecu_7Seg_intialize(_7Seg_config* _7seg)
{
    ...
    {
        gpio_pin_intialize(&(_7seg->_pins[0x00]));
        gpio_pin_intialize(&(_7seg->_pins[0x01]));
        gpio_pin_intialize(&(_7seg->_pins[0x02]));
        gpio_pin_intialize(&(_7seg->_pins[0x03]));
    }
    return ret;
...
Std_ReturnType ecu_7Seg_write(_7Seg_config* _7seg,uint8 num)
{
    ...
    else
    {
        ...
        gpio_write_pin(&(_7seg->_pins[0x00]),(num >> 0) & 0b1);
        gpio_write_pin(&(_7seg->_pins[0x01]),(num >> 1) & 0b1);
        gpio_write_pin(&(_7seg->_pins[0x02]),(num >> 2) & 0b1);
        gpio_write_pin(&(_7seg->_pins[0x03]),(num >> 3) & 0b1);
    }
