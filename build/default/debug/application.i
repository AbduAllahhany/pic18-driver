...
extern _8bit_lcd_config lcd_1;
extern btn_config btn_1;
# 8 "application.c" 2

# 1 "./MCAL_layer/CPPx/hal_ccpx.h" 1
# 12 "./MCAL_layer/CPPx/hal_ccpx.h"
# 1 "./MCAL_layer/CPPx/../INTERRUPT/mcal_internal_interrupt.h" 1
# 12 "./MCAL_layer/CPPx/../INTERRUPT/mcal_internal_interrupt.h"
# 1 "./MCAL_layer/CPPx/../INTERRUPT/mcal_interrupt_manger.h" 1
# 15 "./MCAL_layer/CPPx/../INTERRUPT/mcal_interrupt_manger.h"
# 1 "./MCAL_layer/CPPx/../INTERRUPT/mcal_interrupt_cnfg.h" 1
# 15 "./MCAL_layer/CPPx/../INTERRUPT/mcal_interrupt_manger.h" 2
# 55 "./MCAL_layer/CPPx/../INTERRUPT/mcal_interrupt_manger.h"
...
# 12 "./MCAL_layer/CPPx/../INTERRUPT/mcal_internal_interrupt.h" 2
# 12 "./MCAL_layer/CPPx/hal_ccpx.h" 2




# 1 "./MCAL_layer/CPPx/hal_ccpx_cnfg.h" 1
# 16 "./MCAL_layer/CPPx/hal_ccpx.h" 2
# 47 "./MCAL_layer/CPPx/hal_ccpx.h"
typedef union{
    struct{
        uint8 ccpr_low;
        uint8 ccpr_high;
...
# 58 "./MCAL_layer/TIMER1/mcal_timer1.h"
typedef enum{
...
# 81 "./MCAL_layer/EUSART/mcal_eusart.h"
typedef enum{
...
# 1 "./MCAL_layer/MSSP/I2C/MSSP_I2C.h" 1
# 185 "./MCAL_layer/MSSP/I2C/MSSP_I2C.h"
typedef struct{
...
I2C_t I2C_obj = {
    .Operation_Mode = 0b1000 ,
    .i2c_SMBus_control = 0x01,
    .i2c_slew_rate = 0,
    .master_obj.Speed_mode = 0x01,
...
void app_intialize();
uint8 ack = 1;
uint8 name[] = "Abdallah Hany Ragab Mohamed ";
uint8 address =0xC4;
uint8 data;
int main(){
     ...
     for ( uint8 i = 0;name[i]!='\0' ;i++ ){
        MSSP_I2C_Send_Start_Condition(&I2C_obj);
        MSSP_I2C_Transmit_Byte(&I2C_obj,0xA0,&ack);
        MSSP_I2C_Transmit_Byte(&I2C_obj,address++,&ack);
        MSSP_I2C_Transmit_Byte(&I2C_obj,name[i],&ack);
        MSSP_I2C_Send_Stop_Condition(&I2C_obj);
