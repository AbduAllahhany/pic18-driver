...
# 1 "MCAL_layer/ADC/../compilier.h" 1
# 10 "MCAL_layer/ADC/../compilier.h"
...
# 10 "MCAL_layer/ADC/../compilier.h" 2
...
# 35 "MCAL_layer/ADC/../mcal_std_types.h"
...
# 1 "MCAL_layer/ADC/mcal_adc_cnfg.h" 1
...
# 15 "MCAL_layer/ADC/mcal_adc.h" 2


# 1 "MCAL_layer/ADC/../INTERRUPT/mcal_internal_interrupt.h" 1
# 12 "MCAL_layer/ADC/../INTERRUPT/mcal_internal_interrupt.h"
# 1 "MCAL_layer/ADC/../INTERRUPT/mcal_interrupt_manger.h" 1
# 15 "MCAL_layer/ADC/../INTERRUPT/mcal_interrupt_manger.h"
# 1 "MCAL_layer/ADC/../INTERRUPT/mcal_interrupt_cnfg.h" 1
# 15 "MCAL_layer/ADC/../INTERRUPT/mcal_interrupt_manger.h" 2
# 55 "MCAL_layer/ADC/../INTERRUPT/mcal_interrupt_manger.h"
...
# 17 "MCAL_layer/ADC/mcal_adc.h" 2
# 79 "MCAL_layer/ADC/mcal_adc.h"
typedef enum{
   ADC_FOSC2,
   ADC_FOSC8,
   ADC_FOSC32,
...
# 8 "MCAL_layer/ADC/mcal_adc.c" 2

static Std_ReturnType ADC_channel_cnfg(uint8 _channel);

Interrupt_Handler ADC_InterruptHandler = ((void*)0) ;
Std_ReturnType mcal_ADC_initialize(const ADC_config *_adc)
{
    ...
    else
    {
         ...
         do{ ADCON1bits.VCFG0 = _adc->voltage_reference; ADCON1bits.VCFG1 = _adc->voltage_reference; }while(0);;

         ADCON2bits.ADFM = _adc->result_format;

         mcal_ADC_select_channel(_adc,_adc->_channel);

         ADCON2bits.ACQT = _adc->_TAD;

         ADCON2bits.ADCS = _adc->_FREQ;
# 49 "MCAL_layer/ADC/mcal_adc.c"
         INTCONbits.PEIE = 1;
         INTCONbits.GIE = 1;
...
Std_ReturnType mcal_ADC_is_conversion_done(const ADC_config *_adc, uint8 *conversion_status)
{
    ...
    {
        *conversion_status = !(ADCON0bits.GO_DONE);
    }
    return ret;
