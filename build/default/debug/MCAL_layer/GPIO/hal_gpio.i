...
# 1 "MCAL_layer/GPIO/../compilier.h" 1
# 10 "MCAL_layer/GPIO/../compilier.h"
...
# 10 "MCAL_layer/GPIO/../compilier.h" 2
...
Std_ReturnType gpio_pin_direction_intialize (const pin_config *_pin_config)
{
    ...
    if(_pin_config == ((void*)0) || _pin_config->port_index >= (uint8)0x05 )
    {
    ...
    else
    {
        switch(_pin_config->direction)
        {
                case (OUTPUT_DIRECTION):
                    (*TRIS_REG[_pin_config->port_index] &= ~((uint8)0x01 << (_pin_config->pin_index)));
                    break;
...
{
    Std_ReturnType ret = (Std_ReturnType)0x0;
    if(_pin_config == ((void*)0) || _direction_status == ((void*)0)
                           || _pin_config->port_index >= (uint8)0x05)
    {
        ret = (Std_ReturnType)0x1;
    }
    else
    {
       *_direction_status = ((*TRIS_REG[_pin_config->port_index] >> _pin_config->pin_index) & (uint8)0x01);
    }
    return ret;
}
...
Std_ReturnType gpio_write_pin(const pin_config *_pin_config,logic_t _logic)
{
    Std_ReturnType ret = (Std_ReturnType)0x0;
    if(_pin_config == ((void*)0) || _pin_config->port_index >= (uint8)0x05
      || _pin_config->pin_index >= (uint8)0x08
      ||(_pin_config->pin_index >= (uint8)0x04 && _pin_config->port_index == PORTE_INDEX))
    {
             ret = (Std_ReturnType)0x1;
    }
    else
    {
        ...
        {
            case 0x1:
                (*LAT_REG[_pin_config->port_index] |= ((uint8)0x01 << _pin_config->pin_index));
                break;
            case 0x0:
                (*LAT_REG[_pin_config->port_index] &= ~((uint8)0x01 << _pin_config->pin_index));
                break;
...
{
    Std_ReturnType ret = (Std_ReturnType)0x0;
    if(_pin_config == ((void*)0) || _pin_config->port_index >= (uint8)0x05 || _logic == ((void*)0)
      || _pin_config->pin_index >= (uint8)0x08
      ||(_pin_config->pin_index >= (uint8)0x04 && _pin_config->port_index == PORTE_INDEX))
    {
        ret = (Std_ReturnType)0x1;
    ...
    {
       *_logic = ((*PORT_REG[_pin_config->port_index] >> _pin_config->pin_index) & (uint8)0x01);
    }
    return ret;
}
...
{
    Std_ReturnType ret = (Std_ReturnType)0x0;
    if(_port >= (uint8)0x05 || _direction == ((void*)0))
    {
        ret = (Std_ReturnType)0x1;
    }
    else
...
{
       Std_ReturnType ret = (Std_ReturnType)0x0;
    if(_port >= (uint8)0x05 || logic == ((void*)0))
    {
        ret = (Std_ReturnType)0x1;
    }
    else
