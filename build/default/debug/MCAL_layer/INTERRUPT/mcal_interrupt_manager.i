...
# 13 "MCAL_layer/INTERRUPT/../GPIO/../mcal_std_types.h"
# 1 "MCAL_layer/INTERRUPT/../GPIO/../compilier.h" 1
# 10 "MCAL_layer/INTERRUPT/../GPIO/../compilier.h"
...
# 10 "MCAL_layer/INTERRUPT/../GPIO/../compilier.h" 2
...
# 35 "MCAL_layer/INTERRUPT/../GPIO/../mcal_std_types.h"
...
# 15 "MCAL_layer/INTERRUPT/mcal_interrupt_manger.h" 2
# 55 "MCAL_layer/INTERRUPT/mcal_interrupt_manger.h"
...
void __attribute__((picinterrupt(("")))) interrupt_manger()
{
    if(INTCONbits.INT0F == 0x01 && INTCONbits.INT0E == 0x01 )
    {
         INT0_ISR();
    }
    if(INTCON3bits.INT1F == 0x01 && INTCON3bits.INT1E == 0x01)
    {
         INT1_ISR();
    }
    if(INTCON3bits.INT2F == 0x01 && INTCON3bits.INT2E == 0x01)
    {
        INT2_ISR();
    }


    if(INTCONbits.RBIF == 0x01 && INTCONbits.RBIE == 0x01 && PORTBbits.RB4 == HIGH && RB4_flag == 1)
    {
        RB4_flag = 0;
        RB4_ISR(0x01);
    }
    if(INTCONbits.RBIF == 0x01 && INTCONbits.RBIE == 0x01 && PORTBbits.RB4 == LOW && RB4_flag == 0)
    {
        RB4_flag = 1;
        RB4_ISR(0x00);
    }
    if(INTCONbits.RBIF == 0x01 && INTCONbits.RBIE == 0x01 && PORTBbits.RB5 == HIGH && RB5_flag == 1)
    {
        RB5_flag = 0;
        RB5_ISR(0x01);
    }
    if(INTCONbits.RBIF == 0x01 && INTCONbits.RBIE == 0x01 && PORTBbits.RB5 == LOW && RB5_flag == 0)
    {
        RB5_flag = 1;
        RB5_ISR(0x00);
    }
    if(INTCONbits.RBIF == 0x01 && INTCONbits.RBIE == 0x01 && PORTBbits.RB6 == HIGH && RB6_flag == 1)
    {
        RB6_flag = 0;
        RB6_ISR(0x01);
    }
    if(INTCONbits.RBIF == 0x01 && INTCONbits.RBIE == 0x01 && PORTBbits.RB6 == LOW && RB6_flag == 0)
    {
        RB6_flag = 1;
        RB6_ISR(0x00);
    }
    if(INTCONbits.RBIF == 0x01 && INTCONbits.RBIE == 0x01 && PORTBbits.RB7 == HIGH && RB7_flag == 1)
    {
        RB7_flag = 0;
        RB7_ISR(0x01);
    }
    if(INTCONbits.RBIF == 0x01 && INTCONbits.RBIE == 0x01 && PORTBbits.RB7 == LOW && RB7_flag == 0)
    {
        RB5_flag = 1;
        RB7_ISR(0x00);
    }
