# 1 "MCAL_layer/MSSP/I2C/MCAL_I2C.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL_layer/MSSP/I2C/MCAL_I2C.c" 2
...
# 13 "MCAL_layer/MSSP/I2C/MSSP_I2C.h"
# 1 "MCAL_layer/MSSP/I2C/../../INTERRUPT/mcal_internal_interrupt.h" 1
# 12 "MCAL_layer/MSSP/I2C/../../INTERRUPT/mcal_internal_interrupt.h"
# 1 "MCAL_layer/MSSP/I2C/../../INTERRUPT/mcal_interrupt_manger.h" 1
# 12 "MCAL_layer/MSSP/I2C/../../INTERRUPT/mcal_interrupt_manger.h"
...
# 12 "MCAL_layer/MSSP/I2C/../../INTERRUPT/mcal_interrupt_manger.h" 2

# 1 "MCAL_layer/MSSP/I2C/../../INTERRUPT/../GPIO/hal_gpio.h" 1
# 14 "MCAL_layer/MSSP/I2C/../../INTERRUPT/../GPIO/hal_gpio.h"
# 1 "MCAL_layer/MSSP/I2C/../../INTERRUPT/../GPIO/../mcal_std_types.h" 1
# 13 "MCAL_layer/MSSP/I2C/../../INTERRUPT/../GPIO/../mcal_std_types.h"
# 1 "MCAL_layer/MSSP/I2C/../../INTERRUPT/../GPIO/../compilier.h" 1
# 10 "MCAL_layer/MSSP/I2C/../../INTERRUPT/../GPIO/../compilier.h"
...
# 10 "MCAL_layer/MSSP/I2C/../../INTERRUPT/../GPIO/../compilier.h" 2
# 13 "MCAL_layer/MSSP/I2C/../../INTERRUPT/../GPIO/../mcal_std_types.h" 2

# 1 "MCAL_layer/MSSP/I2C/../../INTERRUPT/../GPIO/../std_libraries.h" 1
# 13 "MCAL_layer/MSSP/I2C/../../INTERRUPT/../GPIO/../std_libraries.h"
...
# 13 "MCAL_layer/MSSP/I2C/../../INTERRUPT/../GPIO/../std_libraries.h" 2
...
# 15 "MCAL_layer/MSSP/I2C/../../INTERRUPT/../GPIO/../std_libraries.h" 2
...
# 16 "MCAL_layer/MSSP/I2C/../../INTERRUPT/../GPIO/../std_libraries.h" 2
# 14 "MCAL_layer/MSSP/I2C/../../INTERRUPT/../GPIO/../mcal_std_types.h" 2
# 35 "MCAL_layer/MSSP/I2C/../../INTERRUPT/../GPIO/../mcal_std_types.h"
...
# 14 "MCAL_layer/MSSP/I2C/../../INTERRUPT/../GPIO/hal_gpio.h" 2

# 1 "MCAL_layer/MSSP/I2C/../../INTERRUPT/../GPIO/../device_config.h" 1
# 15 "MCAL_layer/MSSP/I2C/../../INTERRUPT/../GPIO/hal_gpio.h" 2

# 1 "MCAL_layer/MSSP/I2C/../../INTERRUPT/../GPIO/hal_gpio_config.h" 1
# 16 "MCAL_layer/MSSP/I2C/../../INTERRUPT/../GPIO/hal_gpio.h" 2
# 42 "MCAL_layer/MSSP/I2C/../../INTERRUPT/../GPIO/hal_gpio.h"
typedef enum{
    LOW = 0,
    HIGH
}logic_t;
...
# 13 "MCAL_layer/MSSP/I2C/../../INTERRUPT/mcal_interrupt_manger.h" 2


# 1 "MCAL_layer/MSSP/I2C/../../INTERRUPT/mcal_interrupt_cnfg.h" 1
# 15 "MCAL_layer/MSSP/I2C/../../INTERRUPT/mcal_interrupt_manger.h" 2
# 55 "MCAL_layer/MSSP/I2C/../../INTERRUPT/mcal_interrupt_manger.h"
...
# 12 "MCAL_layer/MSSP/I2C/../../INTERRUPT/mcal_internal_interrupt.h" 2
# 13 "MCAL_layer/MSSP/I2C/MSSP_I2C.h" 2
...
Std_ReturnType MSSP_I2C_Recevie_Byte(const I2C_t *i2c_obj
                                 ,uint8 *data);
# 8 "MCAL_layer/MSSP/I2C/MCAL_I2C.c" 2
...
static Interrupt_Handler I2C_default_Interrupt_handler = ((void*)0);
static Interrupt_Handler I2C_Bus_Col_Interrupt_handler = ((void*)0);
...
Std_ReturnType MSSP_I2C_Send_Start_Condition(const I2C_t * i2c_obj){
    ...
    if(i2c_obj == ((void*)0) ){
        ...
        SSPCON2bits.SEN = 1;
        while(SSPCON2bits.SEN == 0x01);
        PIR1bits.SSPIF = 0;
        if(SSPSTATbits.S == 0x01){
...
Std_ReturnType MSSP_I2C_Send_Stop_Condition(const I2C_t * i2c_obj){
    ...
    if(i2c_obj == ((void*)0) ){
        ...
        SSPCON2bits.PEN = 1;
        while(SSPCON2bits.PEN == 0x01);
        PIR1bits.SSPIF = 0;
        if(SSPSTATbits.P == 0x01){
            ret |= (Std_ReturnType)0x0;
        }
    }
    return ret;
...
Std_ReturnType MSSP_I2C_Transmit_Byte(const I2C_t *i2c_obj,uint8 data,uint8 *ack){
    ...
    if(i2c_obj == ((void*)0)){
        ...
        SSPBUF = data;
        while(SSPSTATbits.BF == 0x01);
        *ack |= SSPCON2bits.ACKSTAT;
    }
    return ret;
}
Std_ReturnType MSSP_I2C_Recevie_Byte(const I2C_t *i2c_obj,uint8 *data){
    Std_ReturnType ret = (Std_ReturnType)0x1;
    if(i2c_obj == ((void*)0)){
        ret = (Std_ReturnType)0x1;
    }
...
static Std_ReturnType I2C_SMBus_Confg(const I2C_t * i2c_obj){
    ...
    if(i2c_obj == ((void*)0)){
        ...
        if(i2c_obj->i2c_SMBus_control == 0x01 ){
             SSPSTATbits.CKE = 1;
             ret = (Std_ReturnType)0x0;
         }
         else{
...
static Std_ReturnType I2C_Master_Confg(const I2C_t * i2c_obj){
     Std_ReturnType ret = (Std_ReturnType)0x1;
    if(i2c_obj == ((void*)0) || i2c_obj->Operation_Mode != 0b1000){
        ret = (Std_ReturnType)0x1;
    }
    else{
       if((i2c_obj->master_obj).Speed_mode == 0x01){
            SSPADD = (4000000UL / (4 * 400000))-1;
            ret = (Std_ReturnType)0x0;

        }
        else if ((i2c_obj->master_obj).Speed_mode == 0x00){
            SSPADD = (4000000UL / (4 * 100000))-1;
            ret = (Std_ReturnType)0x0;
        }
...
static Std_ReturnType I2C_Slave_Confg(const I2C_t *i2c_obj){
    ...
    if(i2c_obj == ((void*)0)){
        ...
        if(i2c_obj->slave_obj.i2c_General_Call == 0x01){
            SSPCON2bits.GCEN = 1;
        }
        else{
         SSPCON2bits.GCEN = 0;
...
static Std_ReturnType I2C_Mode_Configuration(const I2C_t *i2c_obj){
    ...
    if(i2c_obj == ((void*)0)){
        ret = (Std_ReturnType)0x1;
         ...
         SSPCON1bits.SSPM = i2c_obj->Operation_Mode;
        if(i2c_obj->Operation_Mode == 0b1000){
...
# 277 "MCAL_layer/MSSP/I2C/MCAL_I2C.c"
    INTCONbits.GIE = 1;
    INTCONbits.PEIE = 1;
