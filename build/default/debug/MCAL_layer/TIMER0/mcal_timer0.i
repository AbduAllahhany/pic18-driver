...
# 13 "MCAL_layer/TIMER0/mcal_timer0.h"
...
# 1 "MCAL_layer/TIMER0/../compilier.h" 1
# 10 "MCAL_layer/TIMER0/../compilier.h"
...
# 10 "MCAL_layer/TIMER0/../compilier.h" 2
...
# 1 "MCAL_layer/TIMER0/mcal_timer0_cnfg.h" 1
...
# 1 "MCAL_layer/TIMER0/../INTERRUPT/mcal_interrupt_manger.h" 1
# 15 "MCAL_layer/TIMER0/../INTERRUPT/mcal_interrupt_manger.h"
# 1 "MCAL_layer/TIMER0/../INTERRUPT/mcal_interrupt_cnfg.h" 1
# 15 "MCAL_layer/TIMER0/../INTERRUPT/mcal_interrupt_manger.h" 2
# 55 "MCAL_layer/TIMER0/../INTERRUPT/mcal_interrupt_manger.h"
...
# 17 "MCAL_layer/TIMER0/mcal_timer0.h" 2
# 44 "MCAL_layer/TIMER0/mcal_timer0.h"
typedef enum{
    Freq_Divided_by_2 = 0,
    Freq_Divided_by_4 ,
    Freq_Divided_by_8 ,
...
static __attribute__((inline)) Std_ReturnType timer0_set_size(const timer0_cnfg_t* timer0);
static __attribute__((inline)) Std_ReturnType timer0_select_mode(const timer0_cnfg_t* timer0);
static __attribute__((inline)) Std_ReturnType timer0_clock_src_edge(const timer0_cnfg_t* timer0);
static __attribute__((inline)) Std_ReturnType timer0_prescaler_cnfg(const timer0_cnfg_t* timer0);
static __attribute__((inline)) Std_ReturnType write_val_TMR0L_TMR0H(uint16 val);
...
# 55 "MCAL_layer/TIMER0/mcal_timer0.c"
    INTCONbits.GIE = 1;
    INTCONbits.PEIE = 1;
...
static __attribute__((inline)) Std_ReturnType timer0_prescaler_cnfg(const timer0_cnfg_t* timer0)
{
    ...
    else
    {
        switch (timer0->timer0_prescaler_cnfg)
        {
            ...
            case (0x01):
                T0CONbits.PSA = 0;
                T0CONbits.T0PS = timer0->timer0_prescaler_val;
                break;
            default:
                ret = (Std_ReturnType)0x1;
        }
